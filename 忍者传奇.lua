...
GemsTab:Button({
    ...
    Callback = function()
        local args = {
            [1] = "convertGems",
            [2] = -
        }
...
公告：就在12月13日上午13点左右，开始修改金币发生错误，目前已修复。]],
    TextSize = 14,
    TextTransparency = .3,
})
